...
export class DbService {
  ...
  getRoomPeoples(building_id, room_number,user_id) {
    return this.exec(PhpMethodNames.GET_ROOM_PEOPLES, { building_id: building_id, room_number: room_number,user_id:user_id })
  }
